/**
 * Curated Lucide icon path data (MIT). Inlined as raw SVG inner markup so the
 * renderer can stamp them via `dangerouslySetInnerHTML` without depending on a
 * separate npm package.
 *
 * To add a new icon: grab its SVG body from https://lucide.dev/icons and paste
 * everything between the outer `<svg>...</svg>` tags here. All icons render in
 * a 24×24 viewBox at currentColor stroke.
 */
...
export const ICONS = {
  ...
  tag: '<path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"/><line x1="7" y1="7" x2="7" y2="7"/>',
  ...
  leaf: '<path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19.2 2.96a1 1 0 0 1 1.8.66c.66 5 .66 7 0 9.78A6.86 6.86 0 0 1 14 19.4a8.39 8.39 0 0 1-3 .6z"/><path d="M2 21c0-3 1.85-5.36 5.08-6"/>',
...
/** Returns a `<svg>...</svg>` string for the named icon, or null if not found. */
export function getIconSvg(
  ...
  return (
    ...
    `viewBox="${ICON_VIEWBOX}" fill="none" stroke="currentColor" stroke-width="${sw}" ` +
